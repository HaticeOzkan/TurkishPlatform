...
namespace TurkishPlatform.Areas.Panel.Controllers
{
    public class CountriesController : Controller
    {
        ...
        // GET: Panel/Countries/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: Panel/Countries/Create
