...
namespace TurkishPlatform.Areas.Panel.Controllers
{
    public class ForumCommentCategoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CategoryId,CategoryName,CountryId,Explain,ImageUrl")] ForumCommentCategory forumCommentCategory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CategoryId,CategoryName,CountryId,Explain,ImageUrl")] ForumCommentCategory forumCommentCategory)
        {
            if (ModelState.IsValid)
            {
