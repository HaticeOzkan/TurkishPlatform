...
namespace TurkishPlatform.Areas.Panel.Controllers
{
    public class ForumCommentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CommentId,Content,Date,UserId,CommentTopicId")] ForumComment forumComment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CommentId,Content,Date,UserId,CommentTopicId")] ForumComment forumComment)
        {
            if (ModelState.IsValid)
            {
