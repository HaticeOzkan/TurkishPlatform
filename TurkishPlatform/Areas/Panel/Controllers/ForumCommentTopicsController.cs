...
namespace TurkishPlatform.Areas.Panel.Controllers
{
    public class ForumCommentTopicsController : Controller
    {
        ...
        {
            var forumCommentTopics = db.ForumCommentTopics.Include(f => f.CommentCategory);
        ...
        public ActionResult Create([Bind(Include = "TopicId,TopicTitle,CommentCategoryId")] ForumCommentTopic forumCommentTopic)
        {
            ...
            ViewBag.CommentCategoryId = new SelectList(db.ForumCommentCategories, "CategoryId", "CategoryName", forumCommentTopic.CommentCategoryId);
            return View(forumCommentTopic);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TopicId,TopicTitle,CommentCategoryId")] ForumCommentTopic forumCommentTopic)
        {
            if (ModelState.IsValid)
            {
